...
namespace se
{
	namespace rendering
	{
		...
		public:
			...
			void getScreenVertices(Camera2D* _camera, std::vector<glm::vec2>& deposit);
		...
		protected:
			...
			Polygon(BatchManager& _batchManager, const std::vector<glm::vec2>& _cuspData, const PlaneDepth _planeDepth, const float _width, const float _height);

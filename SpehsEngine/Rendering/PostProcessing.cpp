...
int shaderIndex = (int)se::rendering::ShaderName::DefaultPostProc;
...
namespace se
{
	namespace rendering
	{
		...
		void postProcessingEnd()
		{
			...
			//	glBlitFramebuffer(0, 0, se::input::windowWidth, se::input::windowHeight, 0, 0, se::input::windowWidth, se::input::windowHeight, GL_COLOR_BUFFER_BIT, GL_NEAREST);
		...
		void enablePostProcessing()
		{
			...
			//	glTexImage2DMultisample(GL_TEXTURE_2D_MULTISAMPLE, 8, GL_RGBA, se::input::windowWidth, se::input::windowHeight, GL_TRUE);
			...
			//	glRenderbufferStorageMultisample(GL_RENDERBUFFER, 8, GL_RGBA, se::input::windowWidth, se::input::windowHeight);
			...
			//	glRenderbufferStorageMultisample(GL_RENDERBUFFER, 8, GL_DEPTH24_STENCIL8, se::input::windowWidth, se::input::windowHeight);
			...
			//glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, se::input::windowWidth, se::input::windowHeight, 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
			...
			//glRenderbufferStorage(GL_RENDERBUFFER, GL_RGBA8, se::input::windowWidth, se::input::windowHeight);

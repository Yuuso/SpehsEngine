...
namespace se
{
	...
	*/
	...
	public:
		...
		void connectToChangedSignal(ScopedConnection& scopedConnection, const std::function<void(const T&, const T&)>& callback)
		{
	...
	private:
		T value;
		Signal<void(const T&, const T&)> changedSignal;

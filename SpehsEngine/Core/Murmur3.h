...
namespace se
{
	...
	void murmurHash3_x86_128(const void *key, size_t length, uint32_t seed, void *out);
	void murmurHash3_x64_128(const void *key, size_t length, uint32_t seed, void *out);
}

...
{
    mat4 boneMatrix =
          mul(u_model[int(a_indices.x)], a_weight.x)
        + mul(u_model[int(a_indices.y)], a_weight.y)
        + mul(u_model[int(a_indices.z)], a_weight.z)
        + mul(u_model[int(a_indices.w)], a_weight.w);
    ...
    mat4 normalMatrix =
          mul(u_normal[int(a_indices.x)], a_weight.x)
        + mul(u_normal[int(a_indices.y)], a_weight.y)
        + mul(u_normal[int(a_indices.z)], a_weight.z)
        + mul(u_normal[int(a_indices.w)], a_weight.w);

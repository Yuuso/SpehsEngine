$input a_position, a_normal, a_tangent, a_bitangent, a_weight, a_indices, a_texcoord0, i_data0, i_data1, i_data2, i_data3
...
void main()
{
    ...
    mat4 model = mul(instanceModel, boneMatrix);
    ...
    mat4 normal = mul(instanceNormal, boneNormal);
